...
<style>
    ...
    /* Frosty Glass Overlay (Lighter & Blurred) */
    ...
    /* Force White Labels for Visibility */
    .bold-label {{ 
        font-size: 14px; 
    ...
    div.stButton > button:active {{ transform: translateY(2px) !important; box-shadow: 0 1px 0 rgba(0,0,0,0.2) !important; }}
...
/* Custom Title Header with Background Image */
    .title-banner {{
